    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-2 mx-auto">
            <div class="flex flex-col text-center w-full">
                <h2 class="sm:text-2xl text-xl font-medium title-font mb-4 text-gray-900">List Products</h2>
                ...
                @else
                    <table>
                        <thead>
                            <tr class="grid grid-cols-[1fr_8fr_1fr_1fr_1fr] justify-items-start p-2 ">
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr class="grid grid-cols-[1fr_8fr_1fr_1fr_1fr] justify-items-start items-center p-2 odd:bg-white even:bg-gray-50"
                                    wire:key="{{ $product->id }}">
                                    <td>{{ $product->id }}</td>
                                    <td>{{ $product->name }}</td>
                                    <td>{{ $product->count }}</td>
